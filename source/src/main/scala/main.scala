...
object Main extends JFXApp{
    var arg1 = "Srbija2.csv"
    var arg2 = "Cities2.csv"
    var args: Array[String] = List(arg1, arg2).toArray
    ...
    val ga = new GA(cost_matrix, 1000, 100, 1, 0.2, 0.01, 10, prefix)
    ga.run()
    ...
    stage = new JFXApp.PrimaryStage {
        ...
        val img = new Image("file:" + prefix + "srbija.jpg")
        ...
        scene = new Scene(sceneWidth, sceneHeight) {
            ...
            val filename = prefix + "cities.csv"
